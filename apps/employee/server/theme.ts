...
// FIXME: Find a way to import all of this from @technifit/theme without breaking the docker container
// this will also allow us to remove the dependency on colortranslator
...
export { themeSchema, extractThemVariablesFromRequest, defaultTheme };
export type { Theme };
