...
export const meta: MetaFunction = () => [{ title: 'Employee' }, { name: 'description', content: 'Welcome to Remix!' }];
...
export default function Index() {
  ...
  return (
    <div className='container flex flex-col gap-2 py-6'>
      <Typography variant={'h1'}>{t('common:employee.header.title')}</Typography>
