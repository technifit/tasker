...
const typographyVariants = cva('text-foreground', {
  variants: {
    variant: {
      ...
      h2: 'font-cal scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0',
      h3: 'font-cal scroll-m-20 text-2xl font-semibold tracking-tight',
      h4: 'font-cal scroll-m-20 text-xl font-semibold tracking-tight',
      h5: 'font-cal scroll-m-20 text-lg font-semibold tracking-tight',
      h6: 'font-cal scroll-m-20 text-base font-semibold tracking-tight',
